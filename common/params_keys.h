...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DmBlinkAutoTuneSensitivityLevel", {PERSISTENT, INT, "2"}},
    ...
    {"DmBlinkDismissOnDriverInput", {PERSISTENT, BOOL, "1"}},
    {"DmBlinkMaxDurationMs", {PERSISTENT, INT, "1500"}},
    {"DmBlinkMinDurationMs", {PERSISTENT, INT, "100"}},
    {"DmBlinkMinValidPct", {PERSISTENT, INT, "80"}},
    {"DmBlinkOpenThresholdPct", {PERSISTENT, INT, "50"}},
    {"DmSleepCandidateDurationMs", {PERSISTENT, INT, "10000"}},
    ...
    {"LogAutoCleanupEnabled", {PERSISTENT, BOOL, "1"}},
    {"LogCaptureEnabled", {PERSISTENT, BOOL, "1"}},
    ...
    {"OsmRoadsUpdateProgress", {PERSISTENT, INT}},
    {"OsmRoadsDownloadBytes", {PERSISTENT, STRING}},
    {"OsmRoadsDownloadTotalBytes", {PERSISTENT, STRING}},
    {"OsmRoadsUpdatedAt", {PERSISTENT, STRING}},
    {"OsmSpeedCamerasUpdateStatus", {PERSISTENT, STRING}},
    {"OsmSpeedCamerasUpdateError", {PERSISTENT, STRING}},
    {"OsmSpeedCamerasUpdateProgress", {PERSISTENT, INT}},
    {"OsmSpeedCamerasUpdatedAt", {PERSISTENT, STRING}},
    {"OsmSpeedCamerasCsvPath", {PERSISTENT, STRING}},
    {"OsmSpeedCamerasDownloadRows", {PERSISTENT, INT}},
    {"OsmSpeedCamerasDownloadTotalRows", {PERSISTENT, INT}},
    {"OsmSpeedCamerasImportedCount", {PERSISTENT, INT}},
    {"OsmSpeedCamerasMatchedCount", {PERSISTENT, INT}},
    {"OsmSpeedCamerasLookupCount", {PERSISTENT, INT}},
