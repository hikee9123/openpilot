...
ModelTab::ModelTab(CustomPanel *parent, QJsonObject &jsonobj)
  ...
  QObject::connect(changeModelButton, &ButtonControl::clicked, this, [this]() {
    const QStringList items = {"3.Firehose", "2.Steam_Powered", "1.default"};
...
UITab::UITab(CustomPanel *parent, QJsonObject &jsonobj)
  ...
  std::vector<std::tuple<QString, QString, QString, QString>> toggle_defs{
    ...
    { "kegmanCPU", "CPU temperature", "1. Shows CPU temperature (°C). Counts toward the 4-item HUD limit.", "" },
    { "kegmanLag", "UI Lag", "2. Shows UI frame latency (ms). Counts toward the 4-item HUD limit", "" },
    { "kegmanBattery", "Battery Voltage", "3. Shows system/battery voltage (V). Counts toward the 4-item HUD limit.", "" },
    { "kegmanGPU", "GPS Accuracy", "4. Shows GPS horizontal accuracy (m). Counts toward the 4-item HUD limit.", "" },
    { "kegmanAngle", "Steering Angle", "5. Shows steering angle (°). Counts toward the 4-item HUD limit.", "" },
    { "kegmanEngine", "Engine Status", "6. Shows engine state (e.g., RPM/ON-OFF). Counts toward the 4-item HUD limit.", "" },
    { "kegmanDistance", "Relative Distance", "7. Shows radar relative distance (m). Counts toward the 4-item HUD limit.", "" },
    { "kegmanSpeed", "Relative Speed", "8. Shows radar relative speed (m/s). Counts toward the 4-item HUD limit.", "" },
  };
