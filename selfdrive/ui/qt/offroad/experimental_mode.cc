...
ExperimentalModeButton::ExperimentalModeButton(QWidget *parent) : QPushButton(parent) {
  chill_pixmap = QPixmap(":/icons/couch.svg").scaledToWidth(img_width, Qt::SmoothTransformation);
  experimental_pixmap = QPixmap(":/icons/experimental_grey.svg").scaledToWidth(img_width, Qt::SmoothTransformation);
